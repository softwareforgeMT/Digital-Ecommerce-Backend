...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'AssessmentPass Messenger'),
    ...
    */
    'routes' => [
        'prefix' => env('CHATIFY_ROUTES_PREFIX', 'support/chat'),
        // 'middleware' => env('CHATIFY_ROUTES_MIDDLEWARE', ['auth:admin']),
        'namespace' => env('CHATIFY_ROUTES_NAMESPACE', 'App\Http\Controllers\Vendor\Chatify'),
    ],
    'api_routes' => [
        'prefix' => env('CHATIFY_API_ROUTES_PREFIX', 'support/chat/api'),
