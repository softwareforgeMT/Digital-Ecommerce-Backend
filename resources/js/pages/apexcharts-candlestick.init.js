...
if (chartCandlestickBasicColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#basic_candlestick"),
        options
    );
    chart.render();
}
...
var chartCandlestickComboColors = getChartColorsArray(
    "combo_candlestick_chart"
);
if (chartCandlestickComboColors) {
    var optionsBar = {
        series: [
...
// Category X-axis
var chartCandlestickCategoryColors = getChartColorsArray(
...
if (chartCandlestickCategoryColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#category_candlestick"),
        options
    );
    chart.render();
}
...
if (chartCandlestickLineColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#candlestick_with_line"),
        options
    );
    chart.render();
}
