...
if (areachartNegativeColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#area_chart_negative"),
        options
    );
    chart.render();
}
...
if (areachartMonthsColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#area_chart-months"),
        options
    );
    chart.render();
}
...
if (areachartyearsColors) {
    ...
    var chartYears = new ApexCharts(
        document.querySelector("#area_chart-years"),
        optionsYears
    );
    chartYears.render();
}
...
if (areachartstackedColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#area_chart_stacked"),
        options
    );
    chart.render();
}
...
if (areachartirregularColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#area_chart_irregular"),
        options
    );
    chart.render();
}
...
if (areachartirregularColors) {
    ...
    var chart = new ApexCharts(
        document.querySelector("#area-missing-null-value"),
        options
    );
    chart.render();
}
