...
(function () {
    ...
    function countryListClickEvent(item) {
            ...
            function (subitem) {
                ...
                subitem.addEventListener("click", function () {
                    ...
                    if (item.querySelector("button")) {
                        item.querySelector("button img").setAttribute(
                            "src",
                            optionFlagImg
                        );
                        if (item.querySelector("button span")) {
                            item.querySelector("button span").innerHTML =
                                optionCodeNo;
                        }
                    }
                });
            ...
            Array.from(item.querySelectorAll(".dropdown-menu li")).forEach(
                function (subitem) {
                    ...
                    subitem.addEventListener("click", function () {
                        ...
                        item.querySelector(
                            ".flag-input"
                        ).style.backgroundImage = "url(" + optionFlagImg + ")";
        ...
        // data option flag img with name
        Array.from(
            document.querySelectorAll("[data-option-flag-name]")
        ).forEach(function (item) {
