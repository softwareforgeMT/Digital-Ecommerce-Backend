...
if (document.querySelectorAll(".checkout-tab"))
    Array.from(document.querySelectorAll(".checkout-tab")).forEach(function (
        ...
        if (form.querySelectorAll(".nexttab"))
            Array.from(form.querySelectorAll(".nexttab")).forEach(function (
                nextButton
            ) {
        ...
        if (form.querySelectorAll(".previestab"))
            Array.from(form.querySelectorAll(".previestab")).forEach(function (
                prevButton
            ) {
            ...
            Array.from(tabButtons).forEach(function (button, i) {
                ...
                button.addEventListener("click", function () {
                    form.querySelectorAll(".custom-nav .done").length > 0
                        ? Array.from(
                              form.querySelectorAll(".custom-nav .done")
