                                                ...
                                                <div class="d-flex flex-column h-100">
                                                    <div class="mb-4 mb-md-5">
                                                        <a href="index" class="d-block auth-logo">
                                                            <img src="{{ URL::asset('assets/images/logo-dark.svg') }}"
                                                                alt="" height="22"
                                                                class="auth-logo-dark me-start">
                                                            <img src="{{ URL::asset('assets/images/logo-lg.svg') }}"
                                                                alt="" height="22"
                                                    ...
                                                    <div class="auth-content my-auto">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <div class="mt-4">
                                                                    <a href="index" class="btn btn-primary w-100">Back to
                                                                        Home</a>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="col-xxl-8 col-lg-8 col-md-6">
                    <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-8">
                                <div class="mt-4">
                                    <img src="{{ URL::asset('./assets/images/login-img.png') }}" class="img-fluid"
                                        alt="">
                                </div>
