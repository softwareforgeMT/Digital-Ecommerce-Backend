                                ...
                                <div>
                                    ...
                                    <div class="p-2">
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            <div class="text-end">
                                                <button class="ts-btn-04 border-0 w-100" type="submit">Reset</button>
                                            </div>
                                        ...
                                        <div class="mt-4">
                                            <p class="ts-font-poppins ts-desc-06 ts-text-64748b text-center mb-0">
                                                ...
                                                <a class="ts-link ts-text-primary-light ts-fw-medium"
                                                    href="{{ route('user.login') }}"> Click here </a>
                                            </p>
                                        </div>
