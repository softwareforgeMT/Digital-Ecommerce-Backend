                    ...
                    <div class="row  row-cols-lg-2">
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-center gap-3 fs-3 fw-bold mb-3">
                                <a class="text-black " href="{{ route('user.register') }}">Sign
                                    Up</a>
                                <span class="text-black">
                                    Or
                                </span>
                                <a class=" text-primary text-decoration-underline" href="{{ route('user.login') }}">Sign
                                    In</a>
                            </div>
                            ...
                            <div class="d-flex align-items-center h-100">
                                ...
                                <div class="ts-form-container w-100">
                                    ...
                                    <div>
                                        ...
                                        <form action="{{ route('user.login') }}" method="POST">
                                            ...
                                            <div class=" ts-form-control--icon ts-form-control--icon-envelope"
                                                ...
                                                <input type="email" name="email" class="form-control ts-form-control"
                                                    id="emailAddressSignin" placeholder="Email address" autocomplete="email" />

                                            </div>
                                            <div class=" ts-form-control--icon ts-form-control--icon-lock mb-3">
                                            ...
                                            <div class="d-flex justify-content-between my-4">
                                                <div class="form-check">
                                                    <input class="form-check-input ts-focus-1" name="remember" type="checkbox"
                                                        value="1" id="defaultCheck1" />
                                                    <label class="form-check-label" for="defaultCheck1">
                                                        Remember me
                                                    </label>
                                                </div>
                                                <a class="text-primary" href="{{ route('user.forgot') }}">Forgot password?</a>
                                            </div>
                                            <div class="mb-4 text-center">
                                                <button type="submit" class="ts-btn-04 border-0 px-5 mx-auto">Sign In</button>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <ul class="nav ts-form-social-btn d-flex align-items-center gap-3">
                                                @if ($gs->google_login == 1)
                                                    <li>
                                                        <a href="{{ url('oauth/google') }}"><i class="bi bi-google"></i>
                                                        </a>
                                                    </li>
                                                    {{-- <li class="nav-item">
                                                ...
                                                @if ($gs->wechat_login == 1)
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="#">
                                                            <i class="ri ri-wechat-line"></i> Wechat</a>
                                                    </li>
                                                @endif
                                        ...
                                        <div>
                                            <p class="ts-font-poppins ts-desc-06 ts-text-64748b text-center mb-0">
                                                ...
                                                <a class="ts-link ts-text-primary-light ts-fw-medium text-decoration-underline"
                                                    href="{{ route('user.register') }}"> Sign up now
                                                </a>
                                            </p>
                                        </div>
                                    </div>
