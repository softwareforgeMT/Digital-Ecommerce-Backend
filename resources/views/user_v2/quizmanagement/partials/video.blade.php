...
<div class="countdown d-flex align-items-center justify-content-between gap-2 mb-3">
...
<script type="text/javascript">
    ...
    let prepare_time={{$prepare_time}};
   
    startCountdown(prepare_time, "countdown", function() { //This initiates a countdown timer of 120 seconds (2 minutes) as a prep time
      var countdowntext=document.querySelector(".countdown-text");
      startRecording();
      countdowntext.textContent="Recording Time ...";
      startCountdown({{$response_time}}, "countdown", function() {
         stopRecording();    
      });
    });
    
  // Start recording by pression start button without waiting prep time(2mins)  
