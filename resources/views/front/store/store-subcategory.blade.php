        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <div class="w-full lg:w-3/4">
                    ...
                    @php
                        $cards = [
                            ['img' => asset('assets/front/images/brand/brandImage.png'), 'title' => 'Subcategory'],
                            ['img' => asset('assets/front/images/brand/brandImage.png'), 'title' => 'Subcategory'],
                            ['img' => asset('assets/front/images/brand/brandImage.png'), 'title' => 'Subcategory'],
                            ['img' => asset('assets/front/images/brand/brandImage.png'), 'title' => 'Subcategory'],
                            ['img' => asset('assets/front/images/brand/brandImage.png'), 'title' => 'Subcategory'],
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8">
                        @foreach($cards as $card)
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md transform hover:-translate-y-1">
                                ...
                                <div class="p-5">
                                    <h3 class="text-center text-gray-900 dark:text-gray-100 font-medium text-lg mb-2 line-clamp-2 transition duration-200">
                                        <a href="{{ route('front.store.detailed') }}">{{ $card['title'] }}</a>
                                    </h3>
                                </div>
                            </div>
                        @endforeach
