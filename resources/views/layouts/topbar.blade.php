        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="index" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('assets/images/logo-sm-white.svg') }}" alt=""
                                height="22">
                        </span>
                        <span class="logo-lg">
            ...
            <div class="d-flex align-items-center">
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="{{ URL::asset('assets/images/brands/github.png') }}"
                                            alt="Github">
                                        <span>GitHub</span>
                                    </a>
                                </div>
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border"
                            ...
                            <a href="/shopping-cart" class="btn btn-success text-center w-100">
                                Checkout
                            </a>
                        </div>
                    </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome Faye!</h6>
