                    ...
                    <div class="row ms-2">
                        <div class="col-lg-12 col-md-4 m-auto text-end">
                            <a href="{{ route('admin.company.create') }}"
                                class="btn btn-primary waves-effect waves-light">Add Company</a>
                        </div>
                    </div>
                    ...
                    <table id="geniustable" class="table  dt-responsive align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                {{-- <th id="column-3">Category</th>                           
                            <th id="column-4">Location</th> --}}
                                {{-- <th>Status</th> --}}
                                {{-- <th>Banner</th> --}}
                                <th>Status</th>
                                <th>Action</th>
...
@section('script')
    ...
    <script type="text/javascript">
        var url = '{!! route('admin.company.datatables') !!}';
