...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
              <a href="{{ route('admin.product.index') }}">  Career Event </a>
        @endslot
        @slot('title')
            Edit
        @endslot
    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.career.event.update',$data->id) }}" method="post" enctype="multipart/form-data" id="geniusform">
                            @csrf
