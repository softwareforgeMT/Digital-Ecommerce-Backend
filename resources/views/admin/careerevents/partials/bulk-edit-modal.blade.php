                ...
                <div class="modal fade" id="BulkActionModal" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.career.event.bulk.action')}}" method="post" enctype="multipart/form-data" id="ItemsBulkActionForm" class="p-2">
                                @csrf
                                ...
                                <div class="modal-body">
                                    <div id="bulkactionlist">
                                            ...
                                            <div class="form-check form-radio-secondary mb-3">
                                                <input class="form-check-input" type="radio" name="bulkactions" id="mchangemeetingroom" value="mb_meeting_room">
                                                <label class="form-check-label" for="mchangemeetingroom">
                                                   Change Meeting Room Number
                                                </label>
                                            </div>
                                            <div class="form-check form-radio-secondary mb-3">
                                                <input class="form-check-input" type="radio" name="bulkactions" id="mchangelaunchdatetime" value="mb_event_date_time">
                                                <label class="form-check-label" for="mchangelaunchdatetime">
                                    ...
                                    <div class="mbactionslist" >
                                        ...
                                        <div class="actionoptionss" data-id="mchangemeetingroom">
                                            <label class="form-label">Meeting Room Number</label>
                                            <input type="text" name="meeting_id" class="form-control"   placeholder="Enter Meeting ID" value="">

                                        </div>     

                                        <div class="actionoptionss" data-id="mchangelaunchdatetime">
                                             <label class="form-label">Launch Date & Time (UK-UTC)</label>
                                             <input type="datetime-local" name="event_date_time" class="form-control"    value="" >
