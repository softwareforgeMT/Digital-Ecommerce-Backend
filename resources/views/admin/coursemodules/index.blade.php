...
@slot('li_1') <a href="{{ route('admin.course.modules.index') }}"> Modules</a> @endslot
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('admin.course.modules.create') }}" class="btn btn-primary waves-effect waves-light">Add Module</a>
            </div>
            <div class="card-body">
                <table id="geniustable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th data-ordering="false">Modules Name</th>
                            <th data-ordering="false">Course Name</th>
                            {{-- <th>Price</th>                           
                            <th>Create Date</th>
                            <th>Status</th> --}}
                            <th>Status</th>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin.course.modules.datatables') }}',
               columns: [
                        // { data: 'id', name: 'id'},
