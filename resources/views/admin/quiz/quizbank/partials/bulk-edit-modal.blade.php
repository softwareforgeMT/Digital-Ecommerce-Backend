                ...
                <div class="modal fade" id="BulkActionModal" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.quizbank.bulk.action')}}" method="post" enctype="multipart/form-data" id="ItemsBulkActionForm" class="p-2">
                                @csrf
                                        ...
                                        <div class="actionoptionss" data-id="mchangeassessmenttype">
                                            ...
                                            <select class="form-control" name="assessment_type" >
                                                    ...
                                                    @foreach(Helpers::getAssessmentType() as $assessment_type)
                                                     <option value="{{$assessment_type}}" >{{$assessment_type}}</option>
                                                    @endforeach
                                            </select>
