    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.quiz.management.update',$data->id) }}" method="post" enctype="multipart/form-data" id="geniusform">
                            @csrf
                            @include('admin.includes.ajax-alerts')
                            @include('admin.quiz.management.partials.inputs')
