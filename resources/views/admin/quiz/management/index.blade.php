...
@section('title')Quiz Management @endsection
@section('css')
...
@slot('li_1') <a href="{{ route('admin.quiz.management.index') }}"> Quiz Management</a> @endslot
            ...
            <div class="card-header ">
                ...
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-sm-auto">
                          <a href="{{ route('admin.quiz.management.create') }}" class="btn btn-primary waves-effect waves-light"><i class="ri-add-line align-bottom me-1"></i>Quiz Management</a>
                    </div>
...
@include('admin.quiz.management.partials.bulk-edit-modal')
<!-- Delete modal -->
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        var url='{!! route('admin.quiz.management.datatables') !!}';
