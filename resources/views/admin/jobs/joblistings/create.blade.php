...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
              <a href="{{ route('admin.job.listings.index') }}">   Job Listing   </a>
        @endslot
        @slot('title')
            Create
        @endslot
    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.job.listings.store') }}" method="post" enctype="multipart/form-data" id="geniusform">
                            @csrf
                            @include('admin.includes.ajax-alerts')
                            @include('admin.jobs.joblistings.partials.inputs')
