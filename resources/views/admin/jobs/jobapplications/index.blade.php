                    ...
                    <div class="row ms-2">
                        <div class="col-lg-12 col-md-4 m-auto text-end">
                            <a href="{{ route('admin.job.applications.create') }}"
                                class="btn btn-primary waves-effect waves-light">Add Application</a>
                        </div>
                    </div>
                    ...
                    <table id="geniustable" class="table  dt-responsive align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th data-ordering="false">User (Svips)</th>
                                <th data-ordering="false">Jobs Applied</th>
...
@section('script')
    ...
    <script type="text/javascript">
        var url = '{!! route('admin.job.applications.datatables') !!}';
