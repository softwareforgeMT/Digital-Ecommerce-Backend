...
@slot('li_1') <a href="{{ route('admin.location.index') }}"> locations</a> @endslot
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('admin.location.create') }}" class="btn btn-primary waves-effect waves-light">Add location</a>
            </div>
            <div class="card-body">
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin.location.datatables') }}',
               columns: [
                        // { data: 'id', name: 'id'},
