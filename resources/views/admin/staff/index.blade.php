...
@section('title') Manage Staff @endsection
@section('css')
<!--datatable css-->
...
@slot('li_1') <a href="{{ route('admin.staff.index') }}"> Staff</a> @endslot
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('admin.staff.create') }}" class="btn btn-primary waves-effect waves-light">Add </a>
            </div>
            <div class="card-body">
