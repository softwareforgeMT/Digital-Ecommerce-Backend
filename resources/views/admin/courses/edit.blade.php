        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Courses </h4>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.courses.edit',$data->id) }}" method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" name="author" class="form-control" id="basiInput" value="{{$data->author}}">
                                 ...
                                 <div class="col-lg-4"> 
                                    ...
                                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                        <img src="{{$data->photo?asset('/assets/images/courses/'.$data->photo):URL::asset('assets/images/users/user-dummy-img.jpg')}}"
