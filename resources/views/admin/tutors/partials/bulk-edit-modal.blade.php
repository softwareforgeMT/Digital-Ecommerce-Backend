                ...
                <div class="modal fade" id="BulkActionModal" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{route('admin.tutor.bulk.action')}}" method="post" enctype="multipart/form-data" id="ItemsBulkActionForm" class="p-2">
                                @csrf
                                ...
                                <div class="modal-body">
                                    <div id="bulkactionlist">
                                            ...
                                            {{-- <div class="form-check form-radio-secondary mb-3">
                                                <input class="form-check-input" type="radio" name="bulkactions" id="mchangelanguage" value="mb_language">
                                                <label class="form-check-label" for="mchangelanguage">
                                                   Change Language
                                                </label>
                                            </div> --}}
                                    ...
                                    <div class="mbactionslist" >
                                        ...
                                        <div class="actionoptionss" data-id="mchangelanguage">
