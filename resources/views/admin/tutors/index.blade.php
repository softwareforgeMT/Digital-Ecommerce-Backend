...
@section('title')Tutor Management @endsection
@section('css')
...
@slot('li_1') <a href="{{ route('admin.tutor.index') }}"> Tutor Management</a> @endslot
            ...
            <div class="card-header ">
                ...
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-sm-auto">
                          <a href="{{ route('admin.tutor.create') }}" class="btn btn-primary waves-effect waves-light"><i class="ri-add-line align-bottom me-1"></i>Tutor Management</a>
                    </div>
...
@include('admin.tutors.partials.bulk-edit-modal')
<!-- Delete modal -->
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        var url='{!! route('admin.tutor.datatables') !!}';
