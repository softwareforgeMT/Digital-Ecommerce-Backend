        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <h5 class="text-{{$salesPercentage>0?'success':'danger'}} fs-14 mb-0">
                        <i class="ri-arrow-right-{{$salesPercentage>0?'up':'down'}}-line fs-13 align-middle"></i>
                        {{-- +16.24 % --}}
                        {{$salesPercentage}} %
                    </h5>
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">{{ Helpers::generalVariables()['currency_symbol'] }}<span
                            class="counter-value" data-target="{{ Helpers::getPrice($currentSales) }}">0</span>
                            
                    </h4>
                    <a href="{{route('admin.orders.index')}}" class="text-decoration-underline">View Transactions</a>
                </div>
