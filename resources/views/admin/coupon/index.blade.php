...
@slot('li_1') <a href="{{ route('admin.coupon.index') }}"> Coupon</a> @endslot
                ...
                <table id="geniustable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th data-ordering="false">Coupon Name</th>
                            <th>Coupon Code</th>                           
                            <th>Uses</th>
                            <th>Sales</th> 
                            <th>Status</th>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        var url='{!! route('admin.coupon.datatables',compact('coupon_type')) !!}';
