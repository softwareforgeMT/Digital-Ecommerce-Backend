...
@slot('li_1') <a href="{{ route('admin.role.index') }}"> Roles</a> @endslot
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('admin.role.create') }}" class="btn btn-primary waves-effect waves-light">Add </a>
            </div>
            <div class="card-body">
                <table id="geniustable" class="table table-bordered dt-responsive  table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>
