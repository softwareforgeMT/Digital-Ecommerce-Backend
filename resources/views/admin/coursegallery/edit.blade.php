            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.course.gallery.update',$data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <select class="form-control" name="module_id" required>
                                            ...
                                            <option  {{$module->id==$data->module_id?'selected':''}} value="{{$module->id}}">{{$module->name}}</option>
                                            @endforeach
                                         </select>
                                 ...
                                 <div class="col-xxl-3 col-md-6">
                                    <div>
                                        <div class="form-check form-switch form-switch-right">
                                            ...
                                            <input class="form-check-input " type="checkbox" role="switch" name="video_type" id="video_switch"  {{$data->video_type==1?'checked':''}} value="1">   
                                        </div>
                                        
                                        <div id="video_linkss" style="display:{{$data->video_type==1?'':'none'}}">
                                            <small class="text-muted mb-2 d-block">If file size is large, its good to add video name from s3 like video.mp4 </small>
                                            <input type="text" name="video_link" class="form-control"  value="{{$data->video_link}}" placeholder="video.mp4">
                                        </div>
                                        
                                        <div id="video_uploadss" style="display:{{$data->video_type==1?'none':''}}">
                                            ...
                                            <small>video name: {{$data->video?$data->video:'not added'}}</small>
                                        </div>
                                ...
                                <div class="col-lg-4"> 
                                    <h5 class=" mb-3">Video Image </h5>                       
                                     <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                        <img src="{{$data->photo?asset('/assets/images/gallery/'.$data->photo):URL::asset('assets/images/users/user-dummy-img.jpg')}}"
