<header id="page-topbar" class="position-relative left-0">
    <div class="layout-width mw-100">
        <div class="navbar-header">
            <div class="d-flex">
                <!-- LOGO -->
                {{-- <div class="navbar-brand-box horizontal-logo d-flex align-items-center justify-content-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img src="{{ URL::asset('/assets/images/flags/' . (Auth::user()->country ? strtolower(Auth::user()->country->country_code) : 'us') . '.svg') }}"
                            class="rounded" alt="Header Language" height="20">
                    </button>
                </div>
                <div class="ms-1 header-item d-none d-sm-flex">
                    <div class="text-start ms-xl-2" style="border: 1px solid black;border-radius: 3px;padding: 1px 9px">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <a href="{{ route('user.cart') }}"
                        ...
                        <span
                            class="position-absolute topbar-badge cartitem-badge11 fs-10 translate-middle badge rounded-pill bg-info">{{ Session::has('cart') ? count(Session::get('cart')) : 0 }}</span>
                    </a>
                    {{-- <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border"
                            ...
                            <a href="/checkout" class="btn btn-success text-center w-100">
                                Checkout
                            </a>
                        </div>
                    </div>  --}}
                ...
                {{-- <div class="ms-1 header-item d-none d-sm-flex">
                    <button data-href="{{route('layout.mode.update')}}" data-layout-mode="{{Auth::user()->dark_mode < 1 ? 'light' : 'dark'}}" type="button"
                        class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle apt__light-dark-mode">
                        <i class='bx bx-{{Auth::user()->dark_mode < 1 ? 'moon' : 'sun'}} fs-22'></i>
                    </button>
                </div> --}}
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{!! Helpers::image(Auth::user()->photo, 'user/avatar/', 'user.png') !!}"
                                alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->name }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{Auth::user()->role_id==2?'Tutor':'User'}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('user.orders') }}">
                            <i class="bx bx-shopping-bag text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Orders</span></a>

                        <a class="dropdown-item" href="{{ route('user.account-settings') }}"><span
                                class="badge bg-soft-success text-success mt-1 float-end">New</span><i
                                class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Settings</span></a>
                        <a class="dropdown-item" href="{{ route('user.account-settings') }}#changePassword"><i
