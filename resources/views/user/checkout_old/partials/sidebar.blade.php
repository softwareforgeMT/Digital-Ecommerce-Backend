...
<div class="sticky-side-div">
    <div class="card">
        ...
        <div class="card-header bg-soft-light border-bottom-dashed">
            ...
            <form id="couponForm" method="POST" action="{{ route('user.cart.addCoupon') }}">
                @csrf
            ...
            <div class="table-responsive">
                <table class="table table-borderless mb-0">
                    <tbody>
                        ...
                        @php
                        $previousSubscription=App\CentralLogics\Cart::getPreviousPlan();
                        @endphp
                        @if ($previousSubscription['subscription_discount'] > 0)
                            <tr>
                                <td>Previous Subscription Discount <span class="text-muted"></span> : </td>
                                <td class="text-end" id="cart-discount">-
                                    {{ Helpers::setCurrency($previousSubscription['subscription_discount']) }}</td>
                            </tr>
                        @endif
