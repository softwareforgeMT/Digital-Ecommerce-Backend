...
//Table
var options = {
  valueNames: ["id", "currency_name", "pairs", "current_value", "details", "valume", "high", "low", "market_cap"],
  page: perPage,
  pagination: true,
...
isCount = new DOMParser().parseFromString(marketList.items.slice(-1)[0]._values.id, "text/html");
if (document.querySelector(".pagination-next")) document.querySelector(".pagination-next").addEventListener("click", function () {
...
if (document.querySelector(".pagination-prev")) document.querySelector(".pagination-prev").addEventListener("click", function () {
