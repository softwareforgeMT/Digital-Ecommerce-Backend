...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (element) {
        orderList.add({
            id:
                '<a href="apps-ecommerce-order-details" class="fw-medium link-primary">#VZ' +
                element.id +
                "</a>",
    ...
    orderList.remove(
        "id",
        `<a href="apps-ecommerce-order-details" class="fw-medium link-primary">#VZ2101</a>`
    );
};
    ...
    if (typeof ids_array !== "undefined" && ids_array.length > 0) {
        if (confirm("Are you sure you want to delete this?")) {
            Array.from(ids_array).forEach(function (id) {
                orderList.remove(
                    "id",
                    `<a href="apps-ecommerce-order-details" class="fw-medium link-primary">` +
                        id +
                        `</a>`
                );
            });
