  ...
  new gridjs.Grid({
    columns: [{
      ...
      formatter: function formatter(cell) {
        return gridjs.html('<div class="d-flex align-items-center">' + '<div class="flex-shrink-0 me-3">' + '<div class="avatar-sm bg-light rounded p-1"><img src="assets/images/products/' + cell[0] + '" alt="" class="img-fluid d-block"></div>' + "</div>" + '<div class="flex-grow-1">' + '<h5 class="fs-14 mb-1"><a href="apps-ecommerce-product-details" class="text-dark">' + cell[1] + "</a></h5>" + '<p class="text-muted mb-0">Category : <span class="fw-medium">' + cell[2] + "</span></p>" + "</div>" + "</div>");
      }
    }, {
      name: "Stock",
      width: "94px"
...
if (counterValue) {
  ...
  counter && Array.from(counter).forEach(function (a) {
    !function e() {
      var t = +a.getAttribute("data-target"),
        n = +a.innerText,
        o = t / speed;
      o < 1 && (o = 1), n < t ? (a.innerText = (n + o).toFixed(0), setTimeout(e, 1)) : a.innerText = t;
    }();
  });
}
