...
if (classicPickrDemo) Array.from(classicPickrDemo).forEach(function () {
  Pickr.create({
...
if (monolithColorPickr) Array.from(monolithColorPickr).forEach(function () {
  Pickr.create({
...
if (nanoColorPickr) Array.from(nanoColorPickr).forEach(function () {
  Pickr.create({
    el: ".nano-colorpicker",
    theme: "nano",
    "default": "#3577f1",
...
if (demoColorPickr) Array.from(demoColorPickr).forEach(function () {
  Pickr.create({
    el: ".colorpicker-demo",
    theme: "monolith",
    "default": "#405189",
...
if (opacityHueColorPickr) Array.from(opacityHueColorPickr).forEach(function () {
  Pickr.create({
...
if (swatcherColorPickr) Array.from(swatcherColorPickr).forEach(function () {
  Pickr.create({
...
if (inputColorPickr) Array.from(inputColorPickr).forEach(function () {
  Pickr.create({
...
if (formatColorPickr) Array.from(formatColorPickr).forEach(function () {
  Pickr.create({
