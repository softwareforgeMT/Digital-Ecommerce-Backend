...
if (sellerlinecolor1) {
  ...
  var sparklinechart1 = new ApexCharts(document.querySelector("#chart-seller1"), sparklineoptions1);
...
if (sellerlinecolor2) {
  ...
  var sparklinechart2 = new ApexCharts(document.querySelector("#chart-seller2"), sparklineoptions2);
...
if (sellerlinecolor3) {
  ...
  var sparklinechart3 = new ApexCharts(document.querySelector("#chart-seller3"), sparklineoptions3);
...
if (sellerlinecolor4) {
  ...
  var sparklinechart4 = new ApexCharts(document.querySelector("#chart-seller4"), sparklineoptions4);
...
if (sellerlinecolor5) {
  ...
  var sparklinechart5 = new ApexCharts(document.querySelector("#chart-seller5"), sparklineoptions5);
...
if (sellerlinecolor6) {
  ...
  var sparklinechart6 = new ApexCharts(document.querySelector("#chart-seller6"), sparklineoptions6);
...
if (sellerlinecolor7) {
  ...
  var sparklinechart7 = new ApexCharts(document.querySelector("#chart-seller7"), sparklineoptions7);
...
if (sellerlinecolor8) {
  ...
  var sparklinechart8 = new ApexCharts(document.querySelector("#chart-seller8"), sparklineoptions8);
