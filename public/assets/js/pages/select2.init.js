...
formatState = function formatState(state) {
  ...
  var $state = $('<span><img src="' + baseUrl + "/" + state.element.value.toLowerCase() + '.png" class="img-flag rounded" height="18" /> ' + state.text + "</span>");
  return $state;
};
...
formatState = function formatState(state) {
  ...
  var baseUrl = "assets/images/flags/select2";
  var $state = $('<span><img class="img-flag rounded" height="18" /> <span></span></span>');
