...
if (document.getElementById("sa-title")) document.getElementById("sa-title").addEventListener("click", function () {
  Swal.fire({
    title: "The Internet?",
...
//Success Message
if (document.getElementById("sa-success")) document.getElementById("sa-success").addEventListener("click", function () {
  Swal.fire({
    title: "Good job!",
...
//error Message
if (document.getElementById("sa-error")) document.getElementById("sa-error").addEventListener("click", function () {
  Swal.fire({
    title: "Oops...",
...
// long content
if (document.getElementById("sa-longcontent")) document.getElementById("sa-longcontent").addEventListener("click", function () {
  Swal.fire({
...
//Warning Message
if (document.getElementById("sa-warning")) document.getElementById("sa-warning").addEventListener("click", function () {
  Swal.fire({
    title: "Are you sure?",
...
//Parameter
if (document.getElementById("sa-params")) document.getElementById("sa-params").addEventListener("click", function () {
  Swal.fire({
    title: "Are you sure?",
    text: "You won't be able to revert this!",
    icon: "warning",
...
//Custom Image
if (document.getElementById("sa-image")) document.getElementById("sa-image").addEventListener("click", function () {
  Swal.fire({
    title: "Sweet!",
    text: "Modal with a custom image.",
    imageUrl: "assets/images/logo-sm-white.svg",
    imageHeight: 40,
    confirmButtonClass: "btn btn-primary w-xs mt-2",
    buttonsStyling: false,
    animation: false,
...
//Auto Close Timer
if (document.getElementById("sa-close")) document.getElementById("sa-close").addEventListener("click", function () {
  var timerInterval;
  Swal.fire({
...
//custom html alert
if (document.getElementById("custom-html-alert")) document.getElementById("custom-html-alert").addEventListener("click", function () {
...
if (document.getElementById("sa-dialog-three-btn")) document.getElementById("sa-dialog-three-btn").addEventListener("click", function () {
  Swal.fire({
...
//position
if (document.getElementById("sa-position")) document.getElementById("sa-position").addEventListener("click", function () {
  Swal.fire({
    position: "top-end",
    icon: "success",
...
if (document.getElementById("custom-padding-width-alert")) document.getElementById("custom-padding-width-alert").addEventListener("click", function () {
  Swal.fire({
...
//Ajax
if (document.getElementById("ajax-alert")) document.getElementById("ajax-alert").addEventListener("click", function () {
  Swal.fire({
...
if (document.getElementById("custom-sa-error")) document.getElementById("custom-sa-error").addEventListener("click", function () {
  Swal.fire({
...
//Custom error Message
if (document.getElementById("custom-sa-warning")) document.getElementById("custom-sa-warning").addEventListener("click", function () {
  Swal.fire({
...
if (document.getElementById("custom-sa-community")) document.getElementById("custom-sa-community").addEventListener("click", function () {
  Swal.fire(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
    title: "Join Our Community",
    html: "You can use <b>bold text</b>, " + '<a href="//Themesbrand.in/">links</a> ' + "and other HTML tags"
  }, "html", '<div class="mt-3 text-start">' + '<label for="input-email" class="form-label fs-13">Email</label>' + '<input type="email" class="form-control" id="input-email" placeholder="Enter Email Address">' + "</div>"), "imageUrl", "assets/images/logo-sm-white.svg"), "footer", '<p class="fs-13 text-muted mb-0">Already have an account ? <a href="#" class="fw-semibold text-decoration-underline"> Signin </a> </p>'), "imageHeight", 40), "confirmButtonClass", "btn btn-primary w-xs mb-2"), "confirmButtonText", 'Register <i class="ri-arrow-right-line ms-1 align-bottom"></i>'), "buttonsStyling", false), "showCloseButton", true));
});
