...
Portlet();
var growingLoader = function growingLoader() {
...
var customLoader = function customLoader() {
  ...
  if (customLoader1) {
    customLoader1.addEventListener("click", function (elem) {
      ...
      insertEl = '<div class="card-preloader"><div class="card-status"><img src="assets/images/logo-sm-white.svg" alt="" class="img-fluid custom-loader"></div></div>';
      $portlet.children[1].insertAdjacentHTML("beforeend", insertEl);
      var $pd = $portlet.getElementsByClassName("card-preloader")[0];
      setTimeout(function () {
        $pd.remove();
