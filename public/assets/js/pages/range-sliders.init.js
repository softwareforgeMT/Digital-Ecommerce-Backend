...
if (sliderColorScheme) Array.from(sliderColorScheme).forEach(function (slider) {
...
if (multielementslider) Array.from(multielementslider).forEach(function (slider) {
  noUiSlider.create(slider, {
    start: [20, 80],
    connect: true,
    range: {
...
var colors = [0, 0, 0];
if (sliders) Array.from([].slice.call(sliders)).forEach(function (slider, index) {
  noUiSlider.create(slider, {
    start: 127,
    connect: [true, false],
...
if (html5Slider) noUiSlider.create(html5Slider, {
  start: [10, 30],
  connect: true,
  range: {
    min: -20,
...
if (nonLinearSlider) noUiSlider.create(nonLinearSlider, {
  connect: true,
  behaviour: "tap",
  start: [500, 4000],
  range: {
...
if (pipsSlider) noUiSlider.create(pipsSlider, {
  range: {
    min: 0,
    max: 100
  },
...
if (pips) Array.from(pips).forEach(function (ele) {
