...
var third_party_assets = {
    css_js: [
        ...
        {
            name: "cleave.js",
            assets: ["./node_modules/cleave.js/dist/cleave.min.js"],
        },
        {
            name: "apexcharts",
        ...
        {
            name: "chart.js",
            assets: ["./node_modules/chart.js/dist/chart.min.js"],
        },
        {
            name: "fg-emoji-picker",
            assets: ["./node_modules/fg-emoji-picker/fgEmojiPicker.js"],
        },
        ...
        {
            name: "isotope-layout",
            assets: ["./node_modules/isotope-layout/dist/isotope.pkgd.min.js"],
        },
        ...
        {
            name: "list.js",
            assets: ["./node_modules/list.js/dist/list.min.js"],
        },
        {
            name: "multi.js",
            assets: [
        ...
        {
            name: "node-waves",
            assets: ["./node_modules/node-waves/dist/waves.min.js"],
        },
        {
            name: "sortablejs",
...
mix.sass("resources/scss/custom.scss", folder.dist_assets + "css")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/custom.css");

// mix.sass("resources/scss/admin-custom.scss", folder.dist_assets + "css")
//     .options({ processCssUrls: false })
//     .minify(folder.dist_assets + "css/admin-custom.css");

// =========== Front End
mix.sass('resources/scss/front/common.scss', folder.dist_assets + "css/front/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/common.css");
mix.sass('resources/scss/front/pages/co-detail.scss', folder.dist_assets + "css/front/pages/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/pages/co-detail.css");
mix.sass('resources/scss/front/pages/companies.scss', folder.dist_assets + "css/front/pages/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/pages/companies.css");
mix.sass('resources/scss/front/pages/form.scss', folder.dist_assets + "css/front/pages/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/pages/form.css");
mix.sass('resources/scss/front/pages/index.scss', folder.dist_assets + "css/front/pages/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/pages/index.css");
mix.sass('resources/scss/front/pages/pricing.scss', folder.dist_assets + "css/front/pages/")
    .options({ processCssUrls: false })
    .minify(folder.dist_assets + "css/front/pages/pricing.css");
...
mix.combine(
    ...
    folder.dist_assets + "js/plugins.min.js"
);

mix.combine("resources/js/layout.js", folder.dist_assets + "js/layout.js");
mix.combine(
    "resources/js/bootstrap.js",
    folder.dist_assets + "js/bootstrap.min.js"
);
...
mix.combine(
    ...
    folder.dist_assets + "js/pages/leaflet-us-states.js"
);
mix.combine(
    "resources/js/pages/form-wizard.init.js",
    folder.dist_assets + "js/pages/form-wizard.init.js"
);
mix.combine(
    "resources/js/pages/crm-leads.init.js",
    folder.dist_assets + "js/pages/crm-leads.init.js"
);
mix.combine(
    "resources/js/pages/crm-companies.init.js",
    folder.dist_assets + "js/pages/crm-companies.init.js"
);
mix.combine(
    "resources/js/pages/crm-contact.init.js",
    folder.dist_assets + "js/pages/crm-contact.init.js"
);
mix.combine(
    "resources/js/pages/ecommerce-order.init.js",
    folder.dist_assets + "js/pages/ecommerce-order.init.js"
);
mix.combine(
    "resources/js/pages/ecommerce-customer-list.init.js",
    folder.dist_assets + "js/pages/ecommerce-customer-list.init.js"
);
mix.combine(
    "resources/js/pages/ecommerce-cart.init.js",
    folder.dist_assets + "js/pages/ecommerce-cart.init.js"
);
mix.combine(
    "resources/js/pages/tasks-list.init.js",
    folder.dist_assets + "js/pages/tasks-list.init.js"
);
mix.combine(
    "resources/js/pages/invoicecreate.init.js",
    folder.dist_assets + "js/pages/invoicecreate.init.js"
);
mix.combine(
    "resources/js/pages/invoicedetails.js",
    folder.dist_assets + "js/pages/invoicedetails.js"
);
mix.combine(
    "resources/js/pages/invoiceslist.init.js",
    folder.dist_assets + "js/pages/invoiceslist.init.js"
);
mix.combine(
    "resources/js/pages/ticketlist.init.js",
    folder.dist_assets + "js/pages/ticketlist.init.js"
);
mix.combine(
    "resources/js/pages/listjs.init.js",
    folder.dist_assets + "js/pages/listjs.init.js"
);
mix.combine(
    "resources/js/pages/calendar.init.js",
    folder.dist_assets + "js/pages/calendar.init.js"
);
mix.combine(
    "resources/js/pages/plugins/lord-icon-2.1.0.js",
    folder.dist_assets + "js/pages/plugins/lord-icon-2.1.0.min.js"
);
mix.combine(
    "resources/js/pages/plugins/jsonfull-emoji-list.json",
    folder.dist_assets + "js/pages/plugins/jsonfull-emoji-list.json"
);
mix.combine(
    "resources/js/pages/plugins/event.init.json",
    folder.dist_assets + "js/pages/plugins/event.init.json"
);
